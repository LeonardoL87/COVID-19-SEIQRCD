...
X0=Y1(end,:)
param1=[alpha1,beta1,gamma1,delta1,Lambda1,K1,1,tau];
[Y2] = SEIQRDCRatio(param1,X0,t(rel+1:end));%this is a version of SEIQRDC in which we can set the value of tau according to the ratio. The only difference with the reported in this document it's T(i)= tau.
...
% save('SimulationsRatio.mat','S','E','I','Q','R','D','C');%To save the simulations  
